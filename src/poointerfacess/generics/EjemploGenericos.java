package poointerfacess.generics;

import poointerfacess.poointerfaces.modelo.Cliente;
import poointerfacess.poointerfaces.modelo.ClientePremiun;
...
public class EjemploGenericos {
    public static void main(String[] args) {
            ...
            clientes.add(new Cliente("javier ", "Lagos"));
            ...
            List<ClientePremiun> clientesPremiumList = fromArrayToList(
                    new ClientePremiun[]{new ClientePremiun("Paco", "Fernández")});
